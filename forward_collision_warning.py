...
def check_warning_needed(cars, own_x, own_y, own_heading, own_speed, accelerator, brake, gear, setting, warn_multi,
    ...
    for car in car_in_front:
        ...
        if ok and gear > 0 and speed > 1 and speed - car[0].speed < 130:

            if car[0].distance < calc_brake_distance(speed - car[0].speed, accelerator, brake,
                                                     car[0].dynamic, car[0].cname) * multiply[0] + warn_length:
                collision_warning = 3
            elif car[0].distance < calc_brake_distance(speed - car[0].speed, accelerator, brake,

...
def sensors(cars, own_x, own_y, own_heading):
    sensordata = []
    closest_distance = 4
    angle = 0
    ...
    (x1, y1) = calc_polygon_points(own_x, own_y, 2.8 * 65536, ang1)  # front left
    (x2, y2) = calc_polygon_points(own_x, own_y, 2.8 * 65536, ang2)  # rear left
    (x3, y3) = calc_polygon_points(own_x, own_y, 2.8 * 65536, ang3)  # rear right
    (x4, y4) = calc_polygon_points(own_x, own_y, 2.8 * 65536, ang4)  # front right
    (x5, y5) = calc_polygon_points(own_x, own_y, 4 * 65536, ang1)
    (x6, y6) = calc_polygon_points(own_x, own_y, 4 * 65536, ang2)
    (x7, y7) = calc_polygon_points(own_x, own_y, 4 * 65536, ang3)
    (x8, y8) = calc_polygon_points(own_x, own_y, 4 * 65536, ang4)
    (x9, y9) = calc_polygon_points(own_x, own_y, 5 * 65536, ang1)
    (x10, y10) = calc_polygon_points(own_x, own_y, 5 * 65536, ang2)
    (x11, y11) = calc_polygon_points(own_x, own_y, 5 * 65536, ang3)
    (x12, y12) = calc_polygon_points(own_x, own_y, 5 * 65536, ang4)
    (x13, y13) = calc_polygon_points(own_x, own_y, 6 * 65536, ang4)
    (x14, y14) = calc_polygon_points(own_x, own_y, 6 * 65536, ang1)
    (x15, y15) = calc_polygon_points(own_x, own_y, 6 * 65536, ang2)
    (x16, y16) = calc_polygon_points(own_x, own_y, 6 * 65536, ang3)

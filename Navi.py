...
points_westhill = {
    ...
    "Intersection_Bridge_East": {"coords": (-101, 104, 6), "neighbors": ["Intersection_Bridge_North", "Intersection_Bridge_South", "Intersection_PaddockBridge_West"]},
    ...
    "Intersection_WesternMiddle_West": {"coords": (153, 162, 11), "neighbors": ["Intersection_PaddockBridge_East", "Intersection_WesternMiddle_South", "Intersection_WesternMiddle_North"]},
    ...
    "Intersection_ParkBridge_North": {"coords": (308, -383, 7), "neighbors": ["Intersection_ParkBridge_West", "Intersection_ParkBridge_East", "Intersection_RaceEastPark_West"]},
    ...
    "Intersection_ParkBridge2_South": {"coords": (286, -425, 8), "neighbors": ["Intersection_ParkBridge2_West", "Intersection_ParkBridge2_East", "Corner_ParkSmallSouth_North"]},
    ...
    "Intersection_ParkMiddle_South": {"coords": (18, -521, 22), "neighbors": ["Intersection_ParkMiddle_West", "Intersection_ParkMiddle_East", "Intersection_RaceSouthPark2_North"]},
    "Intersection_ParkMiddle_West": {"coords": (-13, -486, 23), "neighbors": ["Intersection_ParkMiddle_South", "Intersection_ParkMiddle_East", "Intersection_RaceNationalPark2_East"]},
    ...
    "Intersection_WesternCarPark_North": {"coords": (149, -1079, 14), "neighbors": ["Intersection_WesternCarPark_South", "Intersection_WesternCarPark_West", "Intersection_WesternCarPark_East", "Intersection_ParkEntrySouth2_South"]},
    ...
    "Intersection_WesternEnd3_North": {"coords": (-280, -972, 25), "neighbors": ["Intersection_WesternEnd3_West", "Intersection_WesternEnd3_East", "Corner_SmallSouthEntry_South"]},
    ...
    "Intersection_WesternEnd3_East": {"coords": (-258, -983, 25), "neighbors": ["Intersection_WesternEnd3_North", "Intersection_WesternEnd3_West", "Intersection_RaceWesternEnd_West"]},
    ...
    "Intersection_SoutEntryDirt2_South": {"coords": (-788, -234, 29), "neighbors": ["Intersection_SoutEntryDirt2_East", "Intersection_SoutEntryDirt2_North", "Intersection_SoutEntryDirt2_West", "Intersection_BehindPoliceHQ2_North"]},
    ...
    "Intersection_PoliceHQ_South": {"coords": (-733, -190, 26), "neighbors": ["Intersection_PoliceHQ_North", "Intersection_PoliceHQ_East", "Intersection_PoliceHQ_West", "Intersection_BehindPoliceHQ_North"]},
    ...
    "Intersection_NorthEntryScavier_North": {"coords": (-774, -40, 26), "neighbors": ["Intersection_NorthEntryScavier_South", "Intersection_NorthEntryScavier_East", "Intersection_KartingInternational_South"]},
    ...
    "Intersection_North_South": {"coords": (-538, 769, 16), "neighbors": ["Intersection_North_North", "Intersection_North_East", "Corner_NorthEntry_North"]},
    ...
    "Intersection_NorthWestern2_West": {"coords": (-22, 754, 20), "neighbors": ["Intersection_NorthWestern2_North", "Intersection_NorthWestern2_South", "Intersection_WesternSmall_East"]},
    "Intersection_NorthWestern2_South": {"coords": (-15, 732, 20), "neighbors": ["Intersection_NorthWestern2_North", "Intersection_NorthWestern2_West", "Corner_WesternNorth_North"]},
    ...
    "Intersection_DustinHofmann_West": {"coords": (98, 221, 8), "neighbors": ["Intersection_DustinHofmann_North", "Intersection_DustinHofmann_South", "Intersection_DustinHofmannLot_East"]},
    ...
    "Intersection_EndOfPaddock_East": {"coords": (-147, -338, 19), "neighbors": ["Intersection_EndOfPaddock_North", "Intersection_EndOfPaddock_West", "Intersection_RacePaddock_North"]},
    ...
    "Intersection_KartingNational_South": {"coords": (-330, -71, 15), "neighbors": ["Intersection_KartingNational_West", "Intersection_KartingNational_East", "Corner_NextToKartingNational_South"]},
    ...
    "Intersection_KartingNational2_East": {"coords": (-283, 18, 15), "neighbors": ["Intersection_KartingNational2_North", "Intersection_KartingNational2_South", "Intersection_NextToRace2_West"]},
    ...
    "Intersection_ScavierNorth_East": {"coords": (-341, 705, 13), "neighbors": ["Intersection_ScavierNorth_North", "Intersection_ScavierNorth_South", "Intersection_NextToRace_West"]},
    ...
    "Intersection_KartingInternational_North": {"coords": (-742, 147, 23), "neighbors": ["Intersection_KartingInternational_East", "Intersection_KartingInternational_South", "Corner_NorthEntry_South"]},
    "Intersection_KartingInternational_East": {"coords": (-732, 127, 23), "neighbors": ["Intersection_KartingInternational_North", "Intersection_KartingInternational_South"]},
    "Intersection_KartingInternational_South": {"coords": (-749, 106, 24), "neighbors": ["Intersection_KartingInternational_North", "Intersection_KartingInternational_East", "Intersection_NorthEntryScavier_North"]},

    "Corner_NorthEntry_North": {"coords": (-600, 633, 19), "neighbors": ["Corner_NorthEntry_South", "Intersection_North_South"]},
    "Corner_NorthEntry_South": {"coords": (-672, 516, 20), "neighbors": ["Corner_NorthEntry_North", "Intersection_KartingInternational_North"]},

    "Intersection_BehindPoliceHQ_North": {"coords": (-640, -247, 26), "neighbors": ["Intersection_PoliceHQ_South", "Intersection_BehindPoliceHQ_West", "Intersection_BehindPoliceHQ_East"]},
    "Intersection_BehindPoliceHQ_West": {"coords": (-639, -294, 26), "neighbors": ["Intersection_BehindPoliceHQ_North", "Intersection_BehindPoliceHQ_East", "Intersection_BehindPoliceHQ2_East"]},
    "Intersection_BehindPoliceHQ_East": {"coords": (-611, -275, 25), "neighbors": ["Intersection_BehindPoliceHQ_North", "Intersection_BehindPoliceHQ_West", "Intersection_RaceKarting_East"]},

    "Intersection_BehindPoliceHQ2_North": {"coords": (-740, -339, 32), "neighbors": ["Intersection_BehindPoliceHQ2_South", "Intersection_BehindPoliceHQ2_East", "Intersection_SoutEntryDirt2_South"]},
    "Intersection_BehindPoliceHQ2_South": {"coords": (-705, -386, 32), "neighbors": ["Intersection_BehindPoliceHQ2_North", "Intersection_BehindPoliceHQ2_East", "Corner_SmallSouthEntry_North"]},
    "Intersection_BehindPoliceHQ2_East": {"coords": (-693, -337, 30), "neighbors": ["Intersection_BehindPoliceHQ2_North", "Intersection_BehindPoliceHQ2_South", "Intersection_BehindPoliceHQ_West"]},

    "Corner_SmallSouthEntry_North": {"coords": (-438, -621, 33), "neighbors": ["Corner_SmallSouthEntry_South", "Intersection_BehindPoliceHQ2_South"]},
    "Corner_SmallSouthEntry_South": {"coords": (-388, -679, 33), "neighbors": ["Corner_SmallSouthEntry_North", "Intersection_WesternEnd3_North"]},

    "Intersection_RaceWesternEnd_North": {"coords": (-287, -887, 25), "neighbors": ["Intersection_RaceWesternEnd_South", "Intersection_RaceWesternEnd_West", "Intersection_RaceNational_South"]},
    "Intersection_RaceWesternEnd_South": {"coords": (-266, -908, 24), "neighbors": ["Intersection_RaceWesternEnd_North", "Intersection_RaceWesternEnd_West", "Intersection_ParkEntrySouth_West"]},
    "Intersection_RaceWesternEnd_West": {"coords": (-285, -912, 25), "neighbors": ["Intersection_RaceWesternEnd_North", "Intersection_RaceWesternEnd_South", "Intersection_WesternEnd3_East"]},

    "Intersection_ParkEntrySouth_North": {"coords": (74, -756, 11), "neighbors": ["Intersection_ParkEntrySouth_West", "Intersection_ParkEntrySouth_East", "Intersection_RaceSouthPark_South"]},
    "Intersection_ParkEntrySouth_West": {"coords": (58, -774, 11), "neighbors": ["Intersection_ParkEntrySouth_North", "Intersection_ParkEntrySouth_East", "Intersection_RaceWesternEnd_South"]},
    "Intersection_ParkEntrySouth_East": {"coords": (89, -765, 10), "neighbors": ["Intersection_ParkEntrySouth_North", "Intersection_ParkEntrySouth_West", "Intersection_ParkEntrySouth2_West"]},

    "Intersection_ParkEntrySouth2_North": {"coords": (266, -930, 12), "neighbors": ["Intersection_ParkEntrySouth2_West", "Intersection_ParkEntrySouth2_East", "Intersection_ParkEntrySouth2_South", "Intersection_RaceSouthPark2_South"]},
    "Intersection_ParkEntrySouth2_West": {"coords": (257, -938, 11), "neighbors": ["Intersection_ParkEntrySouth2_North", "Intersection_ParkEntrySouth2_East", "Intersection_ParkEntrySouth2_South", "Intersection_ParkEntrySouth_East"]},
    "Intersection_ParkEntrySouth2_East": {"coords": (309, -975, 11), "neighbors": ["Intersection_ParkEntrySouth2_North", "Intersection_ParkEntrySouth2_West", "Intersection_ParkEntrySouth2_South", "Intersection_RaceChicane_West"]},
    "Intersection_ParkEntrySouth2_South": {"coords": (275, -970, 12), "neighbors": ["Intersection_ParkEntrySouth2_North", "Intersection_ParkEntrySouth2_West", "Intersection_ParkEntrySouth2_East", "Intersection_WesternCarPark_North"]},

    "Intersection_RaceChicane_North": {"coords": (547, -991, 8), "neighbors": ["Intersection_RaceChicane_West", "Intersection_RaceChicane_East", "Corner_ParkSmallSouth_South"]},
    "Intersection_RaceChicane_West": {"coords": (540, -1010, 8), "neighbors": ["Intersection_RaceChicane_North", "Intersection_RaceChicane_East", "Intersection_ParkEntrySouth2_East"]},
    "Intersection_RaceChicane_East": {"coords": (571, -1003, 9), "neighbors": ["Intersection_RaceChicane_North", "Intersection_RaceChicane_West", "Corner_RaceChicane_South"]},

    "Corner_RaceChicane_North": {"coords": (599, -757, 8), "neighbors": ["Corner_RaceChicane_Middle", "Intersection_RaceEastPark_South"]},
    "Corner_RaceChicane_Middle": {"coords": (610, -810, 7), "neighbors": ["Corner_RaceChicane_South", "Corner_RaceChicane_North"]},
    "Corner_RaceChicane_South": {"coords": (582, -877, 7), "neighbors": ["Corner_RaceChicane_Middle", "Intersection_RaceChicane_East"]},

    "Intersection_RaceEastPark_North": {"coords": (288, -297, 5), "neighbors": ["Intersection_RaceEastPark_West", "Intersection_RaceEastPark_South", "Intersection_RaceNationalEast_South"]},
    "Intersection_RaceEastPark_West": {"coords": (298, -338, 4), "neighbors": ["Intersection_RaceEastPark_North", "Intersection_RaceEastPark_South", "Intersection_ParkBridge_North"]},
    "Intersection_RaceEastPark_South": {"coords": (326, -354, 3), "neighbors": ["Intersection_RaceEastPark_North", "Intersection_RaceEastPark_West", "Corner_RaceChicane_North"]},

    "Intersection_RaceNationalEast_North": {"coords": (178, 16, 7), "neighbors": ["Intersection_RaceNationalEast_West", "Intersection_RaceNationalEast_South", "Corner_RaceEast_North"]},
    "Intersection_RaceNationalEast_West": {"coords": (144, -44, 7), "neighbors": ["Intersection_RaceNationalEast_North", "Intersection_RaceNationalEast_South", "Intersection_RacePaddock_East"]},
    "Intersection_RaceNationalEast_South": {"coords": (204, -62, 7), "neighbors": ["Intersection_RaceNationalEast_North", "Intersection_RaceNationalEast_West", "Intersection_RaceEastPark_North"]},

    "Corner_RaceEast_North": {"coords": (-59, 21, 1), "neighbors": ["Intersection_RaceNationalEast_North", "Intersection_RacePaddockBridge_South"]},

    "Intersection_RacePaddockBridge_North": {"coords": (-66, 83, 1), "neighbors": ["Intersection_RacePaddockBridge_East", "Intersection_RacePaddockBridge_South"]},
    "Intersection_RacePaddockBridge_East": {"coords": (-46, 73, 1), "neighbors": ["Intersection_RacePaddockBridge_North", "Intersection_RacePaddockBridge_South", "Intersection_PaddockBridge_South"]},
    "Intersection_RacePaddockBridge_South": {"coords": (-66, 48, 1), "neighbors": ["Intersection_RacePaddockBridge_North", "Intersection_RacePaddockBridge_East", "Corner_RaceEast_North"]},

    "Intersection_PaddockBridge_North": {"coords": (8, -125, 5), "neighbors": ["Intersection_PaddockBridge_South", "Intersection_PaddockBridge_East", "Intersection_PaddockBridge_West", "Intersection_DustinHofmannLot_West"]},
    "Intersection_PaddockBridge_South": {"coords": (-14, 90, 5), "neighbors": ["Intersection_PaddockBridge_North", "Intersection_PaddockBridge_East", "Intersection_PaddockBridge_West", "Intersection_RacePaddockBridge_East"]},
    "Intersection_PaddockBridge_East": {"coords": (32, 109, 6), "neighbors": ["Intersection_PaddockBridge_North", "Intersection_PaddockBridge_South", "Intersection_PaddockBridge_West", "Intersection_WesternMiddle_West"]},
    "Intersection_PaddockBridge_West": {"coords": (-34, 104, 6), "neighbors": ["Intersection_PaddockBridge_North", "Intersection_PaddockBridge_South", "Intersection_PaddockBridge_East", "Intersection_Bridge_East"]},

    "Intersection_DustinHofmannLot_North": {"coords": (-7, 261, 2), "neighbors": ["Intersection_DustinHofmannLot_West", "Intersection_DustinHofmannLot_East", "Corner_DustinHofmann_South"]},
    "Intersection_DustinHofmannLot_West": {"coords": (18, 180, 1), "neighbors": ["Intersection_DustinHofmannLot_North", "Intersection_DustinHofmannLot_East", "Intersection_PaddockBridge_North"]},
    "Intersection_DustinHofmannLot_East": {"coords": (63, 205, 4), "neighbors": ["Intersection_DustinHofmannLot_North", "Intersection_DustinHofmannLot_West", "Intersection_DustinHofmann_West"]},

    "Corner_DustinHofmann_South": {"coords": (-38, 331, 4), "neighbors": ["Intersection_DustinHofmannLot_North", "Corner_DustinHofmann_North"]},
    "Corner_DustinHofmann_North": {"coords": (-55, 483, 12), "neighbors": ["Corner_DustinHofmann_South", "Intersection_WesternSmall_South"]},

    "Intersection_WesternSmall_North": {"coords": (-46, 776, 20), "neighbors": ["Intersection_WesternSmall_South", "Intersection_WesternSmall_East", "Corner_NorthSmall_East"]},
    "Intersection_WesternSmall_South": {"coords": (-52, 733, 19), "neighbors": ["Intersection_WesternSmall_North", "Intersection_WesternSmall_East", "Corner_DustinHofmann_North"]},
    "Intersection_WesternSmall_East": {"coords": (-41, 757, 20), "neighbors": ["Intersection_WesternSmall_North", "Intersection_WesternSmall_South", "Intersection_NorthWestern2_West"]},

    "Corner_NorthSmall_East": {"coords": (-13, 974, 21), "neighbors": ["Corner_NorthSmall_Middle", "Intersection_WesternSmall_North"]},
    "Corner_NorthSmall_Middle": {"coords": (-65, 1020, 21), "neighbors": ["Corner_NorthSmall_East", "Corner_NorthSmall_West"]},
    "Corner_NorthSmall_West": {"coords": (-246, 973, 17), "neighbors": ["Corner_NorthSmall_Middle", "Intersection_NextToRace_North"]},

    "Intersection_NextToRace_North": {"coords": (-237, 770, 9), "neighbors": ["Intersection_NextToRace_West", "Intersection_NextToRace_South", "Corner_NorthSmall_West"]},
    "Intersection_NextToRace_West": {"coords": (-272, 736, 10), "neighbors": ["Intersection_NextToRace_North", "Intersection_NextToRace_South", "Intersection_ScavierNorth_East"]},
    "Intersection_NextToRace_South": {"coords": (-234, 680, 6), "neighbors": ["Intersection_NextToRace_North", "Intersection_NextToRace_West", "Corner_NextToRace_North"]},

    "Corner_NextToRace_North": {"coords": (-234, 525, 3), "neighbors": ["Intersection_NextToRace_South", "Corner_NextToRace_MidNorth"]},
    "Corner_NextToRace_MidNorth": {"coords": (-234, 390, 3), "neighbors": ["Corner_NextToRace_MidSouth", "Corner_NextToRace_North"]},
    "Corner_NextToRace_MidSouth": {"coords": (-234, 219, 6), "neighbors": ["Corner_NextToRace_MidNorth", "Corner_NextToRace_South"]},
    "Corner_NextToRace_South": {"coords": (-233, 149, 9), "neighbors": ["Corner_NextToRace_MidSouth", "Intersection_NextToRace2_North"]},

    "Intersection_NextToRace2_North": {"coords": (-233, 38, 14), "neighbors": ["Intersection_NextToRace2_West", "Intersection_NextToRace2_East", "Intersection_NextToRace2_South", "Corner_NextToRace_South"]},
    "Intersection_NextToRace2_West": {"coords": (-247, 17, 15), "neighbors": ["Intersection_NextToRace2_North", "Intersection_NextToRace2_East", "Intersection_NextToRace2_South", "Intersection_KartingNational2_East"]},
    "Intersection_NextToRace2_East": {"coords": (-228, 15, 15), "neighbors": ["Intersection_NextToRace2_North", "Intersection_NextToRace2_West", "Intersection_NextToRace2_South"]},
    "Intersection_NextToRace2_South": {"coords": (-235, 2, 16), "neighbors": ["Intersection_NextToRace2_North", "Intersection_NextToRace2_West", "Intersection_NextToRace2_East", "Intersection_KartingNextToRace_North"]},

    "Intersection_KartingNextToRace_North": {"coords": (-235, -53, 16), "neighbors": ["Intersection_KartingNextToRace_West", "Intersection_KartingNextToRace_South", "Intersection_NextToRace2_South"]},
    "Intersection_KartingNextToRace_West": {"coords": (-249, -65, 15), "neighbors": ["Intersection_KartingNextToRace_North", "Intersection_KartingNextToRace_South", "Corner_NextToKartingNational_South"]},
    "Intersection_KartingNextToRace_South": {"coords": (-238, -72, 15), "neighbors": ["Intersection_KartingNextToRace_North", "Intersection_KartingNextToRace_West", "Corner_NextToKartingNationalAndRace_South"]},

    "Corner_NextToKartingNational_South": {"coords": (-304, 70, 15), "neighbors": ["Intersection_KartingNextToRace_West", "Intersection_KartingNational_South"]},

    "Corner_NextToKartingNationalAndRace_South": {"coords": (-249, -129, 14), "neighbors": ["Intersection_KartingNextToRace_South", "Intersection_RaceKarting_North"]},

    "Intersection_RaceKarting_North": {"coords": (-328, -176, 16), "neighbors": ["Intersection_RaceKarting_East", "Intersection_RaceKarting_West", "Corner_NextToKartingNationalAndRace_South"]},
    "Intersection_RaceKarting_East": {"coords": (-320, -198, 16), "neighbors": ["Intersection_RaceKarting_North", "Intersection_RaceKarting_West", "Intersection_BehindPoliceHQ_East"]},
    "Intersection_RaceKarting_West": {"coords": (-351, -205, 17), "neighbors": ["Intersection_RaceKarting_North", "Intersection_RaceKarting_East", "Corner_Race_West"]},

    "Corner_Race_West": {"coords": (-606, -309, 25), "neighbors": ["Intersection_RaceKarting_West", "Intersection_RaceNational_North"]},

    "Intersection_RaceNational_North": {"coords": (-425, -603, 33), "neighbors": ["Corner_Race_West", "Intersection_RaceNational_South", "Intersection_RaceNational_East"]},
    "Intersection_RaceNational_South": {"coords": (-372, -668, 33), "neighbors": ["Intersection_RaceNational_North", "Intersection_RaceNational_East", "Intersection_RaceWesternEnd_North"]},
    "Intersection_RaceNational_East": {"coords": (-350, -621, 33), "neighbors": ["Intersection_RaceNational_North", "Intersection_RaceNational_South", "Corner_RaceNational_West"]},

    "Corner_RaceNational_West": {"coords": (-226, -469, 20), "neighbors": ["Intersection_RaceNational_East", "Intersection_RaceNationalMiddle_South"]},

    "Intersection_RaceNationalMiddle_North": {"coords": (-293, -373, 20), "neighbors": ["Intersection_RaceNationalMiddle_South", "Intersection_RaceNationalMiddle_East", "Intersection_RaceNationalMiddle2_West"]},
    "Intersection_RaceNationalMiddle_South": {"coords": (-303, -409, 20), "neighbors": ["Intersection_RaceNationalMiddle_North", "Intersection_RaceNationalMiddle_East", "Corner_RaceNational_West"]},
    "Intersection_RaceNationalMiddle_East": {"coords": (-285, -390, 20), "neighbors": ["Intersection_RaceNationalMiddle_North", "Intersection_RaceNationalMiddle_South", "Intersection_RaceNationalPark_West"]},

    "Intersection_RaceNationalMiddle2_South": {"coords": (-227, -357, 21), "neighbors": ["Intersection_RaceNationalMiddle2_West", "Intersection_RaceNationalMiddle2_East", "Intersection_RaceNationalPark_North"]},
    "Intersection_RaceNationalMiddle2_West": {"coords": (-228, -344, 21), "neighbors": ["Intersection_RaceNationalMiddle2_South", "Intersection_RaceNationalMiddle2_East", "Intersection_RaceNationalMiddle_North"]},
    "Intersection_RaceNationalMiddle2_East": {"coords": (-195, -347, 21), "neighbors": ["Intersection_RaceNationalMiddle2_South", "Intersection_RaceNationalMiddle2_West", "Intersection_RacePaddock_West"]},

    "Intersection_RacePaddock_North": {"coords": (-126, -349, 18), "neighbors": ["Intersection_RacePaddock_West", "Intersection_RacePaddock_East", "Intersection_EndOfPaddock_East"]},
    "Intersection_RacePaddock_West": {"coords": (-140, -356, 19), "neighbors": ["Intersection_RacePaddock_North", "Intersection_RacePaddock_East", "Intersection_RaceNationalMiddle2_East"]},
    "Intersection_RacePaddock_East": {"coords": (-95, -362, 17), "neighbors": ["Intersection_RacePaddock_North", "Intersection_RacePaddock_West", "Intersection_RaceNationalEast_West"]},

    "Intersection_RaceNationalPark_North": {"coords": (-247, -385, 20), "neighbors": ["Intersection_RaceNationalPark_West", "Intersection_RaceNationalPark_East", "Intersection_RaceNationalMiddle2_South"]},
    "Intersection_RaceNationalPark_West": {"coords": (-260, -397, 20), "neighbors": ["Intersection_RaceNationalPark_North", "Intersection_RaceNationalPark_East", "Intersection_RaceNationalMiddle_East"]},
    "Intersection_RaceNationalPark_East": {"coords": (-231, -406, 21), "neighbors": ["Intersection_RaceNationalPark_North", "Intersection_RaceNationalPark_West", "Intersection_RaceNationalPark2_West"]},

    "Intersection_RaceNationalPark2_South": {"coords": (-156, -441, 22), "neighbors": ["Intersection_RaceNationalPark2_West", "Intersection_RaceNationalPark2_East", "Corner_ParkSmall_North"]},
    "Intersection_RaceNationalPark2_West": {"coords": (-171, -423, 22), "neighbors": ["Intersection_RaceNationalPark2_South", "Intersection_RaceNationalPark2_East", "Intersection_RaceNationalPark_East"]},
    "Intersection_RaceNationalPark2_East": {"coords": (-131, -437, 25), "neighbors": ["Intersection_RaceNationalPark2_South", "Intersection_RaceNationalPark2_West", "Intersection_ParkMiddle_West"]},

    "Corner_ParkSmall_North": {"coords": (-339, -654, 33), "neighbors": ["Corner_ParkSmall_South", "Intersection_RaceNationalPark2_South"]},
    "Corner_ParkSmall_South": {"coords": (-254, -867, 24), "neighbors": ["Corner_ParkSmall_North", "Intersection_RaceSouthPark_West"]},

    "Intersection_RaceSouthPark_South": {"coords": (71, -743, 11), "neighbors": ["Intersection_RaceSouthPark_West", "Intersection_RaceSouthPark_East", "Intersection_ParkEntrySouth_North"]},
    "Intersection_RaceSouthPark_West": {"coords": (53, -742, 11), "neighbors": ["Intersection_RaceSouthPark_South", "Intersection_RaceSouthPark_East", "Corner_ParkSmall_South"]},
    "Intersection_RaceSouthPark_East": {"coords": (75, -727, 11), "neighbors": ["Intersection_RaceSouthPark_South", "Intersection_RaceSouthPark_West", "Intersection_RaceSouthPark2_West"]},

    "Intersection_RaceSouthPark2_North": {"coords": (96, -683, 11), "neighbors": ["Intersection_RaceSouthPark2_South", "Intersection_RaceSouthPark2_West", "Intersection_ParkMiddle_South"]},
    "Intersection_RaceSouthPark2_South": {"coords": (131, -711, 11), "neighbors": ["Intersection_RaceSouthPark2_North", "Intersection_RaceSouthPark2_West", "Intersection_ParkEntrySouth2_North"]},
    "Intersection_RaceSouthPark2_West": {"coords": (99, -705, 11), "neighbors": ["Intersection_RaceSouthPark2_North", "Intersection_RaceSouthPark2_South", "Intersection_RaceSouthPark_East"]},

    "Corner_ParkSmallSouth_North": {"coords": (579, -771, 9), "neighbors": ["Corner_ParkSmallSouth_Middle", "Intersection_ParkBridge2_South"]},
    "Corner_ParkSmallSouth_Middle": {"coords": (587, -806, 9), "neighbors": ["Corner_ParkSmallSouth_North", "Corner_ParkSmallSouth_South"]},
    "Corner_ParkSmallSouth_South": {"coords": (566, -873, 8), "neighbors": ["Corner_ParkSmallSouth_Middle", "Intersection_RaceChicane_North"]},
